...
public class BasicManagedProfileFragment extends Fragment
    ...
    /**
     * Package name of PIMS apps
     */
    private static final String PACKAGE_NAME_PIMS = "com.android.apps.work.pim";
    ...
    private void getAllPackages() {
        ...
        final List<ResolveInfo> pkgAppsList = getActivity().getApplicationContext().getPackageManager().queryIntentActivities( mainIntent, 0);
        for(ResolveInfo info : pkgAppsList) {
            Log.d("Activity", info.toString());
        }

        UserManager um = (UserManager) getActivity().getApplicationContext().getSystemService(Context.USER_SERVICE);
        Bundle restrictions = um.getApplicationRestrictions("com.google.android.apps.work.pim");
    }
